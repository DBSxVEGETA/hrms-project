            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 border-l border-gray-200 pl-4">
                <div className="h-10 w-10 rounded-full bg-purple-700 flex items-center justify-center">
                  <span className="text-white font-medium">{authUser && authUser.name && (
                        <span>
                          {authUser.name.split(" ").map(word => word[0]).slice(0, 2).join("").toUpperCase()}
                        </span>
                      )}
                      </span>
                </div>
                <div className="hidden md:block">
                  ...
                  <p className="text-xs text-gray-500">{authUser && authUser.role}</p>
                </div>
              </div>
            </div>
          </div>
